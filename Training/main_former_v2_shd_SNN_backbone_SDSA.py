...
from configs.best_config_SHD_former_SDSA import Config as SHDTConfig
...
if __name__ == '__main__':
    ...
    model = SpikeDrivenTransformer(config, num_classes=config.n_outputs, depths=config.depths).to(device)
