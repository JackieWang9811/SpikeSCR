...
from configs.best_config_GSC_former_TIM_Spikformer import Config as GSCTConfig
...
if __name__ == '__main__':
    ...
    for hidden_dim in config.n_hidden_neurons_list:
        ...
        model = Spikformer(config, num_classes=config.n_outputs, TIM_alpha=config.tim_alpha).to(device)
