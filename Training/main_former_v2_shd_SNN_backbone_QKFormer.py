...
from configs.best_config_SHD_former_QKformer import Config as SHDTConfig
# from best_config_libri import Config as libriConfig
# from spkingformer_v4_9364 import SpikeDrivenTransformer
from module.qkformer import QKFormer
...
if __name__ == '__main__':
    ...
    model = QKFormer(config, num_classes=config.n_outputs).to(device)
